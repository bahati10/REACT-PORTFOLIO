      ...
      <div>
        <header>
          ...
          <div className="blogmain">
            <Link to='/Blog' className="signup"><i className="fa-solid fa-user" /> Sign Up</Link>
